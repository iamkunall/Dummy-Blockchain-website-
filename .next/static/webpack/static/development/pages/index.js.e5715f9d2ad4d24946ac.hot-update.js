...
})([":hover{background-color:#00285C;}.mybox{font-family:Roboto,sans-serif;margin-bottom:1rem;background-color:#144698;opacity:0.75;color:white;font-weight:600;transition:background-color 0.2s;}.mybox:hover{background-color:;}p{margin-right:4rem;font-size:20px;}.icon{margin-right:2rem;font-size:20px;}"]);
...
//# sourceMappingURL=index.js.e5715f9d2ad4d24946ac.hot-update.js.map
...
})(["     min-width:32rem;.mybox{font-family:Roboto,sans-serif;margin-bottom:1rem;background-color:#144698;opacity:0.75;color:white;font-weight:600;transition:background-color 0.2s;}.mybox:hover{background-color:#00285C;}p{margin-right:4rem;font-size:20px;}.icon{margin-right:2rem;font-size:20px;}"]);
...
//# sourceMappingURL=index.js.d6de97725249368e83cb.hot-update.js.map
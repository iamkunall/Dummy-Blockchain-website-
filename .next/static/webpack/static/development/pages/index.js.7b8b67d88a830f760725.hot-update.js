...
})(["padding-left:8rem;:hover{padding-left:6rem;background-color:;}.mybox{font-family:Roboto,sans-serif;margin-bottom:1rem;background-color:#144698;opacity:0.75;color:white;font-weight:600;transition:background-color 0.2s;}.mybox:hover{background-color:#00285C;}p{margin-right:4rem;font-size:20px;}.icon{margin-right:2rem;font-size:20px;}"]);
...
var BannerContent = function BannerContent(props) {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Contanier, {
    ...
    className: "box mybox is-pulled-right",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 37
    },
...
//# sourceMappingURL=index.js.7b8b67d88a830f760725.hot-update.js.map
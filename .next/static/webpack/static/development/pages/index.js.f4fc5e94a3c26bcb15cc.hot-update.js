...
})([":hover{background-color:;}font-family:Roboto,sans-serif;margin-bottom:1rem;background-color:#144698;opacity:0.75;color:white;font-weight:600;transition:background-color 0.2s;.mybox:hover{background-color:#00285C;}p{margin-right:4rem;font-size:20px;}.icon{margin-right:2rem;font-size:20px;}"]);
...
//# sourceMappingURL=index.js.f4fc5e94a3c26bcb15cc.hot-update.js.map
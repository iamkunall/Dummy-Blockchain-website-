...
})(["     .mybox{min-width:32rem;font-family:Roboto,sans-serif;margin-bottom:1rem;background-color:#144698;opacity:0.75;color:white;font-weight:600;transition:background-color 0.2s;}.mybox:hover{min-width:42rem;background-color:#00285C;}p{margin-right:4rem;font-size:20px;}.icon{margin-right:2rem;font-size:20px;}"]);
...
//# sourceMappingURL=index.js.e226b28edbdb0d10c74e.hot-update.js.map